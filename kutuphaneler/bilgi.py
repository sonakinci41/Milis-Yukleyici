...
class StBilgi(Gtk.Grid):
	...
	def dil_ata(self,dil):
		...
		self.sistem_dili_label.set_markup("<b>"+diller.diller[dil]["t40"]+" : </b>"+self.ebeveyn.milis_ayarlari['dil'])
		self.klavye_model_label.set_markup("<b>"+diller.diller[dil]["t41"]+" : </b>"+" ".join(self.ebeveyn.milis_ayarlari['klavye_model']))
		self.klavye_duzen_label.set_markup("<b>"+diller.diller[dil]["t42"]+" : </b>"+" ".join(self.ebeveyn.milis_ayarlari['klavye_duzen']))
		self.klavye_varyant_label.set_markup("<b>"+diller.diller[dil]["t43"]+" : </b>"+" ".join(self.ebeveyn.milis_ayarlari['klavye_varyant']))
		self.konum_label.set_markup("<b>"+diller.diller[dil]["t44"]+" : </b>"+self.ebeveyn.milis_ayarlari['konum'])
		self.kullanici_adi_label.set_markup("<b>"+diller.diller[dil]["t19"]+" : </b>"+self.ebeveyn.milis_ayarlari['kullanici_adi'])
		self.giris_adi_label.set_markup("<b>"+diller.diller[dil]["t20"]+" : </b>"+self.ebeveyn.milis_ayarlari['giris_adi'])
		self.bilgisayar_adi_label.set_markup("<b>"+diller.diller[dil]["t21"]+" : </b>"+self.ebeveyn.milis_ayarlari['bilgisayar_adi'])
		self.kullanici_sifre_label.set_markup("<b>"+diller.diller[dil]["t24"]+" : </b>"+len(self.ebeveyn.milis_ayarlari['kullanici_sifre'])*"*")
		self.yonetici_sifre_label.set_markup("<b>"+diller.diller[dil]["t28"]+" : </b>"+len(self.ebeveyn.milis_ayarlari['yonetici_sifre'])*"*")
		self.otomatik_giris_label.set_markup("<b>"+diller.diller[dil]["t26"]+" : </b>"+str(self.ebeveyn.milis_ayarlari['oto_giris']))
		self.sistem_diski_label.set_markup("<b>"+diller.diller[dil]["t33"]+" : </b>"+self.ebeveyn.milis_ayarlari['sistem_disk'])
		self.takas_diski_label.set_markup("<b>"+diller.diller[dil]["t34"]+" : </b>"+self.ebeveyn.milis_ayarlari['takas_disk'])
		self.uefi_diski_label.set_markup("<b>"+diller.diller[dil]["t35"]+" : </b>"+self.ebeveyn.milis_ayarlari['uefi_disk'])
		self.grub_kur_label.set_markup("<b>"+diller.diller[dil]["t37"]+" : </b>"+str(self.ebeveyn.milis_ayarlari['grub_kur']))
